...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Hi {{ $user->name }},</p>
            <p>You requested to reset your password for <strong>Mamabot</strong>. Your OTP code is:</p>
            ...
            <p>Thanks,<br><strong>Mamabot Team</strong></p>
        </div>
        <div class="footer">
            &copy; {{ date('Y') }} Mamabot. All rights reserved.
        </div>
    </div>
</body>
</html>
